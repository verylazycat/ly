...
CREATE TABLE `SSH` (
  ...
  `confsecurity` int DEFAULT '1',
  `PasswordAuthentication` int DEFAULT '1',
  PRIMARY KEY (`ip`),
  CONSTRAINT `SSH_ibfk_1` FOREIGN KEY (`ip`) REFERENCES `BaseInfo` (`ip`)
...
INSERT INTO `SSH` VALUES ('192.168.1.30',1,0),('192.168.252.1',1,0);
