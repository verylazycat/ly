...
CREATE TABLE `Nameservers` (
  ...
  `DNSdefault` int DEFAULT '1',
  PRIMARY KEY (`ip`),
  CONSTRAINT `Nameservers_ibfk_1` FOREIGN KEY (`ip`) REFERENCES `BaseInfo` (`ip`)
...
INSERT INTO `Nameservers` VALUES ('192.168.1.30',1),('192.168.252.1',1);
